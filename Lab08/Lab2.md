# Lab 2: Improving Code Quality and Maintainability with GitHub Copilot
...
1. Create a new folder named **Lab02** in your `C:\` drive and open it in Visual Studio Code. Sign in with your GitHub account with Copilot license.
