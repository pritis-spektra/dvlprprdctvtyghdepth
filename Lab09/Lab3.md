# Lab 3: Building Rapid Full-Stack Application Prototyping with GitHub Copilot
...
1. Create a new folder named **Lab03** in your `C:\` drive and open it in Visual Studio Code.
