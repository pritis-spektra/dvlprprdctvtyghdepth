...
4.   Note any mismatches Copilot identifies. We'll fix them
    next.**Use /fix for Any Issues Found**
...
4.  If the revenue calculation looks wrong, **this is your moment to
