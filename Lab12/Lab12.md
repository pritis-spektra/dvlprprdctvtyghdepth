...
1. Create a new project folder named **Lab12** in your `C:\` drive and open it in Visual Studio Code. Open **Terminal → New Terminal** and click the dropdown to select **Git Bash**. Run the below commands to set up the project:
